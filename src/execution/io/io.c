...
/*   Updated: 2024/02/18 22:37:50 by fvoicu           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	do_input_redirection(t_minishell *ms, \
				bool is_first_cmd, t_ast_node *file)
{
...
void	do_output_redirection(t_minishell *ms, \
				bool is_last_cmd, t_ast_node *file)
{
	if (file)
	{
